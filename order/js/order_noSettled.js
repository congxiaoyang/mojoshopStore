...
function pageLoad(curr,putawayStatus) {
    $.ajax({
        type:"post",
        url:"http://192.168.1.111:8097/store/order/search/current",
        dataType:"json",
        data:{
        ...
        success:function (arr) {
            ...
            var tbody = $("#orderNoSettled");  //  tbody;
            var str;
            tbody.html("");
            if(status == 200){
                ...
                if(data == ""){
                    ...
                    for(var i in data){
                        ...
                        var dealStatus;
                        switch (data[i].deal){
                            case 1 : dealStatus = "已支付";
                                break;
                            case 0 : dealStatus = "未支付";
                                break;
                        }
...
//  点击修改去修改页面
$("#orderNoSettled").delegate(".changeBtn","click",function () {
...
// 点击 删除
$('#orderNoSettled').delegate(".deleteBtn","click",function(){
    var _this = $(this);
